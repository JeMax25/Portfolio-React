  ...
  return (
    ...
    <section className='w-full h-auto mt-48 p-6 relative z-10 bg-slate-800 dark:bg-slate-50 rounded-3xl'>
      <div className="flex justify-evenly items-center h-full gap-10">
        ...
        <div className="w-2/3">
          <h1 className="text-center text-3xl md:text-4xl lg:text-4xl font-bold lg:mb-6">Acerca de mí</h1>
    ...
    <div className="h-auto w-full relative z-10 bg-slate-800 dark:bg-slate-50 rounded-3xl mt-10 pb-9 pl-9 pr-9  flex-col ">
